...
/**
 * Spring Security Principal — 크리에이터
 * JwtAuthenticationFilter가 AT 파싱 후 SecurityContext에 주입.
 * Controller에서 @AuthenticationPrincipal CreatorPrincipal 로 꺼냄.
 */
public class CreatorPrincipal implements UserDetails {
    ...
    public CreatorPrincipal(Long id, UserStatus status) {
        this.id = id;
        this.status = status;
    }

    public Long getId() { return id; }
    public UserType getUserType() { return UserType.CREATOR; }
